...
function generateRandomColor() {
    ...
    return `rgb(${r}, ${g}, ${b})`; // Fix: return a string representing an RGB color
}
...
function updateScore() {
    scoreDisplay.textContent = `Score: ${score} | Lives: ${lives}`; // Fix: add backticks for string interpolation
}

// End the game
function endGame() {
    messageDisplay.textContent = `Game Over! Final Score: ${score}`; // Fix: add backticks for string interpolation
